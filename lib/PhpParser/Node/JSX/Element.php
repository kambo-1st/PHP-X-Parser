...
class Element extends Expr {
    ...
    public function __construct(
        ...
        // Validate that opening and closing tag names match
        if ($closingName !== null && $name !== $closingName) {
            throw new \PhpParser\Error("JSX element has mismatched opening and closing tags: '<{$name}>' and '</{$closingName}>'");
        }
